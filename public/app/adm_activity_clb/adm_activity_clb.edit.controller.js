(function () {
    angular.module('CLBKNCS')
        .controller('EditActivityClbController', EditActivityClbController);
        EditActivityClbController.$inject = ['$scope', 'ActivityClbService', 'logger', 'SharedService', 'ValidatorPost', '$timeout', 'UploadService'];

    function EditActivityClbController($scope, ActivityClbService, logger, SharedService, ValidatorActivityClb, $timeout, UploadService) {
